...
<html lang="fr">
	...
	<body>
		...
		<section id="accueil">
			...
			<div id="top">
				<h1 class="text-uppercase font-weight-bold">Billet simple pour l'Alaska <br> Un Livre de Jean Forteroche</h1>
			<figure >
				<img id="imgtop" src="images/bannerImg10.jpg" alt="Logo Jean Forteroche"/>
			</figure>
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-10 text-center">
						<h2 class="text-black mt-0">Dernier Chapitre Paru</h2>
